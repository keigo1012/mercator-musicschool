    ...
    <>
      <section className="overflow-hidden bg-white">
        ...
        <div className="mx-auto max-w-5xl px-4 pt-12 pb-8 text-center md:pt-18 md:pb-12">
          <h1 className="hero-catch mx-auto max-w-4xl text-4xl md:text-6xl">
          ...
          <div className="mx-auto mt-8 max-w-3xl rounded-xl border border-slate-950/18 bg-[linear-gradient(180deg,#ffffff_0%,#fbfcfd_100%)] p-6 text-slate-900 shadow-[0_20px_55px_rgba(15,23,42,0.08)] md:p-8">
